...
- Si une réallocation demande d'augmenter une batterie alors qu'une autre batterie doit encore baisser mais reste verrouillée par son cooldown, l'augmentation attend que cette baisse puisse être écrite. Le blueprint préfère alors un court import réseau à un pic d'export causé par deux consignes temporairement incompatibles.
