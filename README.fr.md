...
- La comptabilité de l'export brut ne crédite maintenant que la puissance de décharge qui peut disparaître immédiatement sur une batterie réactive. Une baisse de consigne sur une batterie lente est toujours envoyée, mais l'export qui peut rester pendant que cet équipement lent réagit reste disponible pour une charge d'urgence sur une batterie réactive capable de charger.
