...
- Les batteries à long cooldown ne prennent plus les réductions sur export brut ni les augmentations de décharge tant qu'une batterie réactive capable de charger a encore de la marge pour absorber cet export. Le blueprint garde les batteries plus lentes stables et laisse d'abord les batteries réactives réduire leur décharge ou absorber l'export résiduel en charge ; si la charge opportuniste est déjà active et que l'export brut persiste, les consignes de décharge plus lentes peuvent aussi être réduites pour éviter de charger et décharger en même temps tout en continuant d'exporter.
