...
- Les batteries à long cooldown ne contournent plus leur cooldown pour ces réductions sur export brut. Tant qu'elles sont verrouillées, le blueprint les garde stables et laisse d'abord les batteries réactives réduire leur décharge ou absorber l'export résiduel en charge.
