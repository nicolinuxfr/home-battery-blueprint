...
- `Minimum state of charge for discharge`: reserve threshold below which the slot is removed from discharge allocation and any active discharge target is returned to `0`. The default is `15%`.
