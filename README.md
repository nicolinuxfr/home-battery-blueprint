...
- Long-cooldown batteries no longer bypass their cooldown for those raw-export reductions. While they are locked, the blueprint leaves them stable and lets responsive batteries reduce discharge or absorb the residual export by charging first.
