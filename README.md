...
- Non-reactive batteries no longer take raw-export reductions or discharge increases while a reactive charge-capable battery has room to absorb that export. The blueprint leaves stable batteries untouched and lets reactive batteries reduce discharge or absorb the residual export by charging first; if opportunistic charging is already active and raw export still remains, stable discharge targets can be reduced as well to avoid charging and discharging at the same time while still exporting.
