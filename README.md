...
- Long-cooldown batteries no longer take raw-export reductions or discharge increases while a responsive charge-capable battery has room to absorb that export. The blueprint leaves slower batteries stable and lets responsive batteries reduce discharge or absorb the residual export by charging first.
